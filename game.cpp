...
void Game::addBoardSpaces(){
    ...
    //Vermont
    Property *p10 = new Property("Vermont Avenue", "LightBlue", 100, 6, 12, 30, 550, 50, 50, 50, 55);
    gameSpaceList.push_back(p10);

    //Jail
    Property *p11 = new Property("Jail", "Jail", 0, 0, 0, 0, 0, 0, 0, 0, 0);
    gameSpaceList.push_back(p11);

    //St. Charles Place
    Property *p12 = new Property("St. Charles Place", "Pink", 140, 10, 20, 50, 750, 100, 100, 70, 77);
    ...
    //States Avenue
    Property *p14 = new Property("States Avenue", "Pink", 140, 10, 20, 50, 750, 100, 100, 70, 77);
    gameSpaceList.push_back(p14);

    //Virginia Avenue
    Property *p15 = new Property("Virginia Avenue", "Pink", 160, 12, 24, 60, 900, 100, 100, 80, 88);
    gameSpaceList.push_back(p15);

    //Pennsylvania Railroad
    Property *p16 = new Property("Pennsylvania Avenue", "Railroad", 200, 25, 200, 0, 0, 0, 0, 100, 110);
    gameSpaceList.push_back(p16);

    //St. James Place
    Property *p17 = new Property("St. James Place", "Orange", 180, 14, 28, 70, 950, 100, 100, 90, 99);
    gameSpaceList.push_back(p17);

    //Community Chest
    Property *p18 = new Property("Community Chest 2", "SpecialCard", 0, 0, 0, 0, 0, 0, 0, 0, 0);
    gameSpaceList.push_back(p18);

    //Tennessee Avenue
    Property *p19 = new Property("Tennessee Avenue", "Orange", 180, 14, 28, 70, 950, 100, 100, 90, 99);
    gameSpaceList.push_back(p19);

    //New York Avenue
    Property *p20 = new Property("New York Avenue", "Orange", 200, 16, 32, 80, 1000, 100, 100, 100, 110);
    gameSpaceList.push_back(p20);

    //Free Parking
    Property *p21 = new Property("Free Parking", "FreeParking", 0, 0, 0, 0, 0, 0, 0, 0, 0);
    gameSpaceList.push_back(p21);

    //Kentucky Avenue
    Property *p22 = new Property("Kentucky Avenue", "Red", 220, 18, 36, 90, 1050, 150, 150, 110, 121);
    gameSpaceList.push_back(p22);

    //Chance
    Property *p23 = new Property("Chance 2", "SpecialCard", 0, 0, 0, 0, 0, 0, 0, 0, 0);
    gameSpaceList.push_back(p23);

    //Indiana Avenue
    Property *p24 = new Property("Indiana Avenue", "Red", 220, 18, 36, 90, 1050, 150, 150, 110, 121);
    gameSpaceList.push_back(p24);

    //Illinois Avenue
    Property *p25 = new Property("Illinois Avenue", "Red", 240, 20, 40, 100, 1100, 150, 150, 120, 132);
    gameSpaceList.push_back(p25);

    //B & O Railroad
    Property *p26 = new Property("B. & O. Railroad", "Railroad", 200, 25, 200, 0, 0, 0, 0, 100, 110);
    gameSpaceList.push_back(p26);

    //Atlantic Avenue
    Property *p27 = new Property("Atlantic Avenue", "Yellow", 260, 22, 44, 110, 1150, 150, 150, 130, 143);
    gameSpaceList.push_back(p27);

    //Ventnor Avenue
    Property *p28 = new Property("Ventnor Avenue", "Yellow", 260, 22, 44, 110, 1150, 150, 150, 130, 143);
    ...
    //Marvin Gardens
    Property *p30 = new Property("Marvin Gardens", "Yellow", 280, 24, 48, 120, 1200, 150, 150, 140, 154);
    gameSpaceList.push_back(p30);

    //Go to Jail
    Property *p31 = new Property("Go to Jail", "", 0, 0, 0, 0, 0, 0, 0, 0, 0);
    gameSpaceList.push_back(p31);

    //Pacific Avenue
    Property *p32 = new Property("Pacific Avenue", "Green", 300, 26, 52, 130, 1275, 200, 200, 150, 165);
    gameSpaceList.push_back(p32);

    //North Carolina Avenue
    Property *p33 = new Property("North Carolina Avenue", "Green", 300, 26, 52, 130, 1275, 200, 200, 150, 165);
    gameSpaceList.push_back(p33);

    //Community Chest
    Property *p34 = new Property("Community Chest 3", "SpecialCard", 0, 0, 0, 0, 0, 0, 0, 0, 0);
    gameSpaceList.push_back(p34);

    //Pennsylvania Avenue
    Property *p35 = new Property("Pennsylvania Avenue", "Green", 320, 28, 56, 150, 1400, 200, 200, 160, 176);
    gameSpaceList.push_back(p35);

    //Short Line
    Property *p36 = new Property("Short Line", "Railroad", 200, 25, 200, 0, 0, 0, 0, 100, 110);
    gameSpaceList.push_back(p36);

    //Chance
    Property *p37 = new Property("Chance 3", "SpecialCard", 0, 0, 0, 0, 0, 0, 0, 0, 0);
    gameSpaceList.push_back(p37);

    //Park Place
    Property *p38 = new Property("Park Place", "Blue", 350, 35, 70, 175, 1500, 200, 200, 175, 193);
    gameSpaceList.push_back(p38);

    //Luxury Tax
    Property *p39 = new Property("Luxury Tax", "", 0, 100, 0, 0, 0, 0, 0, 0, 0);
